...
#   - Up to 80 rounds, early stopping with patience=10
...
echo "============================================================"
echo "[1/5] Centralized + FedAvg + FedProx + FedAdam"
echo "============================================================"
python run_experiment.py \
  --methods centralized fedavg fedprox fedadam \
  --rounds 80 --n_clients 20 --alpha 0.3 \
